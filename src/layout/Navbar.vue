      ...
      <div>
        <el-input v-model="input" placeholder="Search">
          <i slot="prefix" style="display: flex;align-items: center;">
            <img class="input-icon-size"
                 src="../assets/search_img.png"
                 alt
            />
          </i>
        </el-input>
      ...
      <div class="parent-center col-right-padding">
        ...
        <div style="margin-left: 50px">
          ...
          <div style="font-size: 16px;display: flex">
            <img src="../assets/polygon.svg" style="width: 21px;height: 21px;align-self: center;">
            {{ balance }} MATIC
          </div>
        </div>
        <div style="margin-left: 50px">
          <div class="gods-number">99+</div>
          <img src="../assets/gouwuche_icon.png" @click="dialogVisible = true" class="default-icon">
          <el-dialog
            title="SHOPPING CART"
            :visible.sync="dialogVisible"
            class="shop-dialog">
            <div>
              <div v-for="(cart) in shoppingStore" class="shop-cart-box">
                <el-container>
                  <el-aside>
                  ...
                  <el-main>
                    <p class="shop-cart-title">
                      ...
                      <span style="float: right;color: #EA3323">${{ cart.price }}</span>
                    </p>
                    ...
                    <p>
                      <el-button icon="el-icon-my-shop-delete" type="text">detach</el-button>
                      <el-button icon="el-icon-my-shop-collect" type="text">collect</el-button>
                    </p>
                  </el-main>
                </el-container>
              </div>
              <div>
                <p>
                  <span class="shop-cart-box-sum-title">Subtotal (2 items)</span>
            ...
            <span slot="footer" class="dialog-footer">
                <el-button @click="dialogVisible = false" class="footer-button-view">View shopping cart</el-button>
                <el-button @click="dialogVisible = false" class="footer-button-set">settlement</el-button>
             </span>
          </el-dialog>
        </div>
        <div style="margin-left: 50px">
          <el-menu background-color="#000000" mode="horizontal" @select="handleSelect">
            <el-submenu index="1">
              <template slot="title">
                <img v-if="!account" src="../assets/geren_icon.png" class="default-icon">
                <div v-else class="account">{{ account }}</div>
              </template>
              <el-menu-item index="1-1" class="profile-menu-item">Profile</el-menu-item>

              <el-menu-item index="1-2" class="profile-menu-item">Staking</el-menu-item>
              <el-menu-item index="1-3" class="profile-menu-item">Referral</el-menu-item>
              <el-menu-item index="1-4" class="profile-menu-item">Inventory</el-menu-item>
              <el-menu-item index="1-5" class="profile-menu-item">Avatar</el-menu-item>
              <el-menu-item index="1-6" class="profile-menu-item">Settings</el-menu-item>
              <el-menu-item index="1-7" class="profile-menu-item" style="color: red">Log Out</el-menu-item>
            </el-submenu>
          </el-menu>
        </div>
      </div>
...
export default {
  ...
  data () {
    return {
      ...
      shoppingStore: [
        {
          image: 'https://img-blog.csdnimg.cn/20201014180756928.png?x-oss-process=image/resize,m_fixed,h_64,w_64',
          title: 'cescsc',
      ...
      this.$web3.eth.getChainId().then(chainId => {
        if (chainId != 80001) {
          this.$web3.currentProvider
            .request(walletUtil.netArgs.testNet).then(() => {
            this.initAccount()
          })
        }
